...
using namespace BaseShape
{
    ...
    public partial class BasicShape : Label
    {
        ...
        /// マウスクリックした時のクライアント座標
        /// </summary>
        private Point _curPt = new Point();

        /// <summary>
        /// マウスクリックした時の本コントロールのサイズ
        /// </summary>
        private Size _curSize = new Size();

        /// <summary>
        /// つまんだピンチの方向
        /// </summary>
        private Pinch.Direction _curPinch = Pinch.Direction.None;
        ...
        public BasicShape()
        {
            var item1 = new ToolStripMenuItem("名称変更");
            var item2 = new ToolStripMenuItem("フォント変更");
            var item3 = new ToolStripMenuItem("色変更");
            _menu.Items.Add("名称変更");
            _menu.Items.Add("フォント変更");
            _menu.Items.Add("色変更");
        ...
        public void ChangeSelectStatus(bool isSelect)
        {
            IsSelected = isSelect;
            Refresh();
        }
